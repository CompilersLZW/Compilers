...
public class EffectService {
    ...
    public List<FilterEffect> getLocalFilters() {
        ...
        filters.add(new FilterEffect("阴天", GPUImageFilterTools.FilterType.GAMMA, 0));
        filters.add(new FilterEffect("反相", GPUImageFilterTools.FilterType.INVERT, 0));
        filters.add(new FilterEffect("浮雕", GPUImageFilterTools.FilterType.EMBOSS, 0));
        filters.add(new FilterEffect("色调分离", GPUImageFilterTools.FilterType.POSTERIZE, 0));
